...
<head>
    ...
    <meta name="Description" content="DIGITIMES daily news calendar"/>
    <meta name="Keywords" content="DIGITIMES, Taiwan, daily news, calendar, archive"/>
    <meta name="referrer" content="unsafe-url"/>
    <meta name="Pragma" content="no_cache"/>
    <title>DIGITIMES archived news</title>
    ...
    <link rel="dns-prefetch" href="https://img.digitimes.com">
        <link rel="preload" href="https://img.digitimes.com/ad/en_20260302_newpowerww_leaderboard.gif" as="image">
<link rel="preload" href="https://img.digitimes.com/ad/en_20260210_asia_button336x90.gif" as="image">
<link rel="preload" href="https://img.digitimes.com/ad/en_20260210_asia_bigbutton.jpg" as="image">
<link rel="preload" href="https://img.digitimes.com/ad/en_20250923_b2b3_bigbutton.jpg" as="image">
    ...
    <link rel="stylesheet" type="text/css" media="all" href="/script/rtnews.css" />
        ...
        $(function () {
            if ($(".col-left").height() < ($(".sidebar-sticky").height() + $(".sidebar-sticky").position().top)) {
                $('#stid').removeClass('sidebar-item');
            }
        });
    </script>
    <style>
    @media screen and (min-width: 992px) {
        .sidebar-item {position: absolute;top: 0;left: 0;width: 100%;height: 100%;padding-right: 15px;padding-left: 15px;}
        .sidebar-sticky {position: relative;position: -webkit-sticky;position: -moz-sticky;position: -ms-sticky;position: -o-sticky;position: sticky;top: 0;}
    }
    ...
    .pagination{font-family: "Open Sans", sans-serif;font-weight: 600; margin-right:5px!important;}
    .pagination .page-item.active .page-link {background-color: #000000;border-color: #dee2e6;}
    .pagination .page-link {color: #000000;}
    .mainnav{margin-bottom:10px;}
    .mainnav .label.label-info {background-color: #aaaaaa;margin:0 5px 0 -1px;line-height: inherit; padding: 7px 12px;font-size:1em;}
    ...
    .keyword-a {text-decoration: none;color: inherit;}
    .media-container a {text-decoration: none;color: inherit;}
    .keyword-main-btn {display: flex;justify-content: center;align-items: center;background-color: #D9D9D9;border-radius: 100px;padding: 8px;width: 90px;cursor: pointer;margin-bottom: 8px;}
    .keyword-btn-container {margin-top:25px;font-family:"Open Sans", sans-serif;border-bottom: 3px solid #aaa;display: flex;align-items: center;font-size:14px;padding-bottom:7px;}
    .popular-title {font-size: 20px;font-weight: bold;margin-bottom: 12px;margin-right: 16px;color: #333;}
    .keyword-btn{color:#000}
    .keyword-btn-container a:not(:last-child){margin-right: 10px;}
    .keyword-main-btn button:hover {cursor: pointer;}
    .keyword-main-btn:hover {background-color: #EE9600;}
    .keyword-main-btn button {border: none;background-color: transparent;}
    .keyword-main-btn:hover button{color: #ffffff;}
    .keyword-main-btn button:hover {color: #ffffff;}
    .orange-color {background-color: rgba(240, 130, 0, 0.15);color: #ffffff;}
    .bgactive {background-color: #D9D9D9;color: #000000;}
    .month-date {border-radius: 100px;width: 70px;height: 70px;background-color: #F0AD4E;border: 6px solid #ff8e57;display: flex;flex-direction: column;justify-content: center;margin-bottom: 8px;}
    .month-date div {display: flex;flex-direction: column;align-items: center;color: #fff;font-size: 16px;}
    .month-date div p {padding-top:2px;font-family:"Open Sans", sans-serif;margin:0;}
    .time-title {display: flex;flex-direction: column;align-items: center;margin-right: 16px;}
    .time-title .year{font-size: 15px;font-family:"Open Sans", sans-serif;font-weight:600;}
    .time-container {display: flex;margin-top: 20px;margin-bottom: 20px;}
    @media screen and (max-width: 500px) {
    .time-container {display: block;margin-top: 20px;margin-bottom: 20px;}
    .media-container {margin-top:20px;}
    }
    .media-container {padding: 16px;background:#fff;border-radius: 8px;box-shadow: var(--frame-shadow);border-radius: var(--border-radius);width:100%;font-family:"Open Sans", sans-serif;line-height:1.4;}
    .media-container div {margin-bottom: 12px;}
    .media-container a:hover {color: #EE9600;}
    .media-container div:last-child{margin-bottom: 0px;}
    .media-container div:not(:last-child) {border-bottom: 1px solid #e9e9e9;padding-bottom: 12px;}
    </style>
  ...
  <div class="mobile-nav" id="mobile-nav">
    ...
    <div class="content-frame">
      ...
      <div class="socail-frame">
	    ...
	    <div class="my-container">
	    	<div class="adrow">
                <div id="banner" class="adcol-8"><div class="text-center"><div class="clclgjs" rel="96835"><a href='/webad/cnv.asp?Seq=96835' target='_blank'><img src="https://img.digitimes.com/ad/en_20260302_newpowerww_leaderboard.gif" class="awh" style="max-width:728px;" border="0" alt="New Power WorldWide 2026" /></a></div></div></div><div id="banner_mid" class="adcol-4"><div class="text-center"><div class="clclgjs" rel="87914"><a href='/webad/cnv.asp?Seq=87914' target='_blank'><img src="https://img.digitimes.com/ad/en_20260210_asia_button336x90.gif" class="awh" style="max-width:336px;" border="0" alt="Research Report Database" /></a></div></div></div>	    	</div>
	    </div>
    </div>
...
<div class="realtime-news">
  ...
  <div class="swiper-container realtime-container">
    <div class="swiper-wrapper">
    	...
    	<div class="row">
    		<div class="col col-left" id="calendar"><div class="keyword-btn-container"><a href="/calendar.php?d=7d" class="keyword-a"><div class="keyword-main-btn orange-color"><button class="keyword-btn">7 days</button></div></a><a href="/calendar.php?d=14d" class="keyword-a"><div class="keyword-main-btn bgactive"><button class="keyword-btn">14 days</button></div></a></div><div class="timeline-container"><div class="time-container"><div class="time-title">
                            ...
                            <div class="media-container"><div><a href="/news/a20260318VL216/meta-metaverse-mark-zuckerberg-mobile.html" class="subject">Meta's pullback on Metaverse shows the limits of the virtual world bet</a></div><div><a href="/news/a20260318PD247/taiwan-manufacturing-development-uk-technology.html" class="subject">UK-Taiwan R&amp;D ties scale up with Foxconn, Turing Space, NSYSU</a></div><div><a href="/news/a20260318PD243/ai-applications-topco-2026-hbm-growth.html" class="subject">AI tailwinds and global reach put Topco on track for double-digit growth in 2026</a></div><div><a href="/news/a20260318PD217/tpk-holding-panel-profit-2025-revenue.html" class="subject">TPK profit jumps as OLED tablets lift touch module pricing</a></div><div><a href="/news/a20260319VL214/microsoft-openai-legal-aws.html" class="subject">Microsoft considers legal action over Amazon-OpenAI cloud deal</a></div><div><a href="/news/a20260319PD228/volkswagen-china-automotive-chips-nvidia-software.html" class="subject">Volkswagen signals shift away from Nvidia as Chinese chips gain ground</a></div><div><a href="/news/a20260318PD228/ipc-demand-accl-market-industrial.html" class="subject">Allied Circuit sees server, IPC market growth boosting 2H26 outlook</a></div><div><a href="/news/a20260319VL202/india-solar-panel-capacity-manufacturing-policy.html" class="subject">India mandates domestic sourcing of solar wafers under expanded approval list policy</a></div><div><a href="/news/a20260319PD233/apple-tim-cook-china-supply-chain-2026.html" class="subject">Apple CEO visits China at 50th anniversary event to strengthen supply chain</a></div><div><a href="/news/a20260319PD221/robotics-taiwan-manufacturing-development-testing.html" class="subject">The 'golden triangle': Inside Taiwan's industrial engine to win the AI robotics race</a></div><div><a href="/news/a20260317PD221/panel-taiwan-semiconductors-supply-chain-materials.html" class="subject">Commentary: Taiwan's display panel makers are quietly becoming chip companies</a></div><div><a href="/news/a20260317PD222/edison-opto-automotive-2026-shipments-taiwan.html" class="subject">Taiwan's Edison Opto charts new course with automotive LEDs as 2026 outlook brightens</a></div><div><a href="/news/a20260317PD226/china-industrial-humanoid-robot-robotics-competition.html" class="subject">China's AI robot industry surges on market freedom and strategic autonomy</a></div><div><a href="/news/a20260317PD229/sdv-automotive-supply-chain-inventory-growth.html" class="subject">Automotive chipmakers exit inventory reset; SDV, electrification define next growth battle</a></div><div><a href="/news/a20260319PD202/price-supply-chain-market-demand-retail.html" class="subject">Analysis: Memory price swings leave e-reader supply chain in the red</a></div><div><a href="/news/a20260319PD216/packaging-intel-ai-chip-tsmc-samsung.html" class="subject">Intel pushes large-area AI packaging to close foundry gap</a></div><div><a href="/news/a20260317VL211/technology-photonics-infrastructure-ceo.html" class="subject">Lumotive creates world's first 2D photonic beamforming chip</a></div></div></div></div><div class="timeline-container"><div class="time-container"><div class="time-title">
                                <div class="month-date">
                                    <div>
                                        <p>Mar</p>
                                        <p>19</p>
                            ...
                            <div class="media-container"><div><a href="/news/a20260319PD234/taiwan-nvidia-gtc-2026-tsmc.html" class="subject">Nvidia hosts Taiwan night at GTC 2026, Huang vows to defend Taiwan</a></div><div><a href="/news/a20260319PD226/gtc-2026-rubin-chips-efficiency.html" class="subject">Analysis: GTC 2026 widens US-China AI compute gap</a></div><div><a href="/news/a20260319PD205/nvidia-groq-rubin-2026-gtc.html" class="subject">Nvidia positions Groq 3 LPUs alongside Vera Rubin for an inference-first era</a></div><div><a href="/news/a20260319PD227/semco-mlcc-automotive-expansion-leo-satellite.html" class="subject">Samsung Electro-Mechanics rumored to supply MLCCs to top private aerospace firm</a></div><div><a href="/news/a20260318PD230/materials-topco-manufacturing-shin-etsu-disruption.html" class="subject">Gulf crisis drives up petrochemical and semiconductor costs</a></div><div><a href="/news/a20260319PD208/taiwan-foxconn-infrastructure-moda-data-center.html" class="subject">Taiwan turns to Stargate playbook: private capital powers AI infrastructure</a></div><div><a href="/news/a20260319PD225/fitipower-subsidiary-malaysia-expansion.html" class="subject">Fitipower opens Malaysia R&amp;D center to boost global innovation and support</a></div><div><a href="/news/a20260319PD213/semiconductors-materials-gallium-gases-cost-middle-east.html" class="subject">China curbs, Middle East tensions drive surge in chip material risks from gallium to helium</a></div><div><a href="/news/a20260319PD201/fit-2026-cooling-transmission-gtc.html" class="subject">Foxconn Interconnect Technology pushes deeper into AI infrastructure with photonic-thermal integration play</a></div><div><a href="/news/a20260318PD242/nvidia-data-ssd-infrastructure-gtc.html" class="subject">Nvidia elevates AI storage, putting NVMe SSD makers at the center</a></div><div><a href="/news/a20260317PD214/honda-2026-sales-development-production.html" class="subject">Honda books US$15.7 billion EV loss after scrapping projects and compensating suppliers</a></div><div><a href="/news/a20260318PD244/intel-xeon-rubin-nvidia-cpu.html" class="subject">Intel Xeon 6 wins CPU slot in Nvidia DGX Rubin, stakes claim in AI inference stack</a></div><div><a href="/news/a20260318PD231/nvidia-rubin-liquid-cooling-ai-server-launch.html" class="subject">Nvidia standardizes Vera Rubin liquid cooling, names four cold plate suppliers</a></div><div><a href="/news/a20260318PD239/techman-nvidia-training-2026-gtc.html" class="subject">Nvidia GTC 2026: Techman Robot showcases motion training tech</a></div><div><a href="/news/a20260317PD230/nvidia-gtc-2026-advantech-bizlink-wistron-wiwynn.html" class="subject">Taiwan's AI supply chain scales at GTC 2026: Foxconn, Wiwynn, Advantech, BizLink deepen Nvidia ties</a></div><div><a href="/news/a20260318PD238/sk-hynix-dividend-capex-market-2025.html" class="subject">SK Hynix posts record pay, R&amp;D, and capex in 2025</a></div><div><a href="/news/a20260319VL212/meta-security-data.html" class="subject">Meta's AI agent goes rogue, triggers data breach from within</a></div><div><a href="/news/a20260319PD224/elan-focaltech-patent-infringement-legal.html" class="subject">Elan wins patent infringement ruling against FocalTech, plans damages claim</a></div><div><a href="/news/a20260319VL210/micron-capex-cleanroom-capacity-demand.html" class="subject">Micron ramps spending as cleanroom constraints cap memory supply</a></div><div><a href="/news/a20260319VL211/photoresist-materials-commercial-arf-production.html" class="subject">China's photoresist push moves from lab wins to mass supply</a></div><div><a href="/news/a20260317PD217/nexperia-taiwan-production-12-inch-dutch.html" class="subject">Nexperia's China split sends orders to Taiwan</a></div><div><a href="/news/a20260317PD224/market-amazon-production-shipments-growth.html" class="subject">Amazon's Trainium 3 rumors clash with supplier optimism</a></div><div><a href="/news/a20260319PD215/tesla-government-supply-chain-lges-vehicle.html" class="subject">US reveals Tesla battery deal with LG, lifting veil on supply chain</a></div><div><a href="/news/a20260319PD200/apple-2026-market-shipments-oppo.html" class="subject">Foldable phone shipments may near 30 million in 2026 as Apple enters market</a></div><div><a href="/news/a20260319PD219/semiconductor-industry-talent-demand-semi-2026.html" class="subject">AI and memory drive semiconductor output to surpass US$1 trillion in 2026</a></div><div><a href="/news/a20260319VL206/taiwan-taipei-hbm-war.html" class="subject">The HBM paradox: why Taipei and Seoul can't afford a diplomatic cold war</a></div><div><a href="/news/a20260319PD214/nvidia-cpu-groq-infrastructure-ai-agent-2026.html" class="subject">Groq anchors Nvidia's inference strategy; CPU redefines architecture for AI agents</a></div><div><a href="/news/a20260319VL209/tencent-revenue-growth-capex-investment.html" class="subject">Tencent to double AI spending on 13% revenue growth as chip curbs reshape capex</a></div><div><a href="/news/a20260319PD218/samsung-amd-hbm4-ai-chip.html" class="subject">AMD, Samsung deepen AI chip ties with HBM4 supply and foundry talks</a></div><div><a href="/news/a20260319VL207/jabil-infrastructure-demand-automotive-earnings.html" class="subject">Strong quarter for Jabil fueled by smart infrastructure and automotive demand</a></div><div><a href="/news/a20260319PD211/infrastructure-hardware-chips-niche-demand.html" class="subject">Column: OpenClaw pulls AI from cloud to the edge</a></div><div><a href="/news/a20260319PD212/tier-1-auto-components-cost-vehicle-2025.html" class="subject">As Chinese automakers push overseas, Western suppliers reclaim upper hand</a></div><div><a href="/news/a20260319PD210/samsung-production-tesla-business-2026.html" class="subject">Samsung maps out semiconductor strategy with multi-year contracts, Tesla chip on track for 2H27</a></div><div><a href="/news/a20260319VL205/micron-nand-revenue-growth.html" class="subject">Micron forecasts record revenue as memory supply tightens</a></div><div><a href="/news/a20260319PD209/chipmakers-price-cost-inventory-taiwan.html" class="subject">Chip price surge in 2Q26 shifts cost pressure to end markets</a></div><div><a href="/news/a20260319PD207/china-ai-agent-software-alibaba-bytedance-tencent-2026.html" class="subject">Column: OpenClaw ignites China's AI agent land grab</a></div><div><a href="/news/a20260319PD206/nvidia-optical-communications-cpo-intelliepi.html" class="subject">Nvidia signals optical future, but materials shortages stand in the way</a></div><div><a href="/news/a20260319VL204/micron-memory-chips-demand-earnings.html" class="subject">Analysis on Micron's strategic pivot: de-commoditizing the memory industry</a></div><div><a href="/news/a20260319VL203/micron-memory-chips-revenue-2026.html" class="subject">Micron delivers record-breaking 2Q26 financial results driven by AI demand</a></div><div><a href="/news/a20260319VL200/samsung-amd-hbm4-partnership-ddr5.html" class="subject">Samsung, AMD expand AI memory and compute partnership with MOU to align HBM4 supply and DDR5 support</a></div><div><a href="/news/a20260319PD204/naver-amd-infrastructure-gpu-lisa-su.html" class="subject">AMD deepens ties with Naver in bid to expand AI infrastructure</a></div><div><a href="/news/a20260319VL201/intel-packaging-government-testing-policy.html" class="subject">Intel to expand EMIB capabilities in Malaysia amid Section 232 probe uncertainty</a></div><div><a href="/news/a20260318VL211/on-device-ai-chipmakers-silicon-hardware-chips.html" class="subject">Analysis: China's on-device AI chipmakers rush to supply OpenClaw, race for edge AI silicon leadership</a></div><div><a href="/news/a20260318VL209/12-inch-china-28nm-mature-process-hua-hong-semiconductor-nexchip-silan.html" class="subject">China's mature-node push gathers pace: Nexchip, Silan, Hua Hong step up capacity and integration</a></div><div><a href="/news/a20260318VL202/nvidia-groq-gtc-ai-inference-chips.html" class="subject">Nvidia adopts Groq to tackle AI inference and expand global reach</a></div><div><a href="/news/a20260318PD233/market-byd-2026-subsidies-sales.html" class="subject">BYD slides as foreign automakers reclaim ground in China</a></div><div><a href="/news/a20260318PD222/rapidus-2nm-funding-production-government.html" class="subject">Rapidus scales back US 2nm R&amp;D early, raising timeline and funding concerns</a></div><div><a href="/news/a20260318VL208/sk-hynix-hbm4-demand-hbm-production.html" class="subject">SK Hynix presses ahead on HBM4 despite tightening AI memory supply</a></div><div><a href="/news/a20260317PD234/samsung-strike-labor-market-business.html" class="subject">Samsung strike vote nears, DS and DX divisions clash over bonuses</a></div><div><a href="/news/a20260317VL213/supply-chain-production-shipping-semiconductor-industry-disruption.html" class="subject">Hormuz blockade triggers domino effect across semiconductor supply chain</a></div><div><a href="/news/a20260317VL216/samsung-management-business-electronics-2025.html" class="subject">Samsung reportedly broadens emergency management as chipflation takes off</a></div><div><a href="/news/a20260316VL203/taiwan-partnership-government.html" class="subject">Interview: Satellites, talent, and a new UK-Taiwan space pact</a></div><div><a href="/news/a20260318PD215/acer-economy-revenue-market-smart-city.html" class="subject">Acer ITS makes 'healing economy' micro-payment push to expand beyond smart transport</a></div><div><a href="/news/a20260318PD209/cost-economy-demand-gpu-training.html" class="subject">Column: Cheap tokens are masking an expensive problem</a></div><div><a href="/news/a20260318PD206/equipment-supply-chain-adoption-production-packaging.html" class="subject">How Hwaseong became South Korea's semiconductor supply-chain capital</a></div><div><a href="/news/a20260318PD203/taiwan-electricity-nuclear-security-renewable-energy.html" class="subject">Taiwan energy debate intensifies as Middle East tensions raise supply concerns</a></div></div></div></div><div class="timeline-container"><div class="time-container"><div class="time-title">
                                <div class="month-date">
                                    <div>
                                        <p>Mar</p>
                                        <p>18</p>
                            ...
                            <div class="media-container"><div><a href="/news/a20260318VL217/amd-samsung-naver-ceo-lisa-su.html" class="subject">AMD's Lisa Su courts Korea: Samsung HBM4 sealed, Naver next</a></div><div><a href="/news/a20260318PD224/nexcom-humanoid-robot-development-nvidia-certification.html" class="subject">Nexcom launches humanoid robot development kit built on Nvidia IGX Thor</a></div><div><a href="/news/a20260318PD236/nvidia-robotics-chipmakers-industrial-control-2026.html" class="subject">Nvidia partners with chipmakers to advance industrial robotics</a></div><div><a href="/news/a20260317VL222/rohm-india-partnership-power-semiconductors-packaging-automotive.html" class="subject">Rohm eyes India as emerging hub for power semiconductor packaging and automotive supply</a></div><div><a href="/news/a20260318PD202/taiwan-6g-standards-development-industrial.html" class="subject">MOEA says 6G standard to be finalized by 2029, urges early preparation</a></div><div><a href="/news/a20260318PD214/asus-foxconn-smart-city-taiwan-infrastructure.html" class="subject">Asus, Foxconn take Taiwan smart city model global</a></div><div><a href="/news/a20260318VL215/chips-nvidia-groq-market-ai-inference.html" class="subject">Nvidia reportedly preparing Groq AI chips for the Chinese market</a></div><div><a href="/news/a20260317PD219/taiwan-manufacturing-development-partnership-data.html" class="subject">Exclusive: Britain and Taiwan forge new pipeline for space engineers</a></div><div><a href="/news/a20260318VL214/samsung-groq-wafer-nvidia-gtc-2026.html" class="subject">The signature on the wafer: Samsung, Nvidia, and Groq close loop on AI inference</a></div><div><a href="/news/a20260318PD227/nvidia-gtc-jensen-huang-2026-ceo.html" class="subject">Jensen Huang's survival playbook: Nvidia navigates the next AI frontier</a></div><div><a href="/news/a20260318PD229/openclaw-tencent-sponsor-ai-agent.html" class="subject">Tencent joins OpenClaw as sponsor after copy dispute, aligns with OpenAI and Baidu</a></div><div><a href="/news/a20260317PD208/china-automakers-north-america-policy-2027.html" class="subject">Chinese automakers navigate North America but face 2027 compliance barriers</a></div><div><a href="/news/a20260318VL205/meta-acquisition-startup-ceo-google.html" class="subject">How Meta's Manus acquisition ignited a new tech war</a></div><div><a href="/news/a20260317PD233/samsung-talent-apple-ibm-mobile.html" class="subject">Samsung taps Apple, IBM, Walmart executives in global talent push</a></div><div><a href="/news/a20260318PD226/infrastructure-gtc-demand-hardware-efficiency.html" class="subject">Nvidia GTC 2026: Memory, power, and deployment challenges reshape AI infrastructure</a></div><div><a href="/news/a20260318PD225/monitor-lg-display-tcl-electronics-technology.html" class="subject">TCL's OLED debut exposes China's Korean panel dependence</a></div><div><a href="/news/a20260318PD221/adata-price-demand-profit-samsung.html" class="subject">Adata profits soar on memory price rally amid supply crunch</a></div><div><a href="/news/a20260318VL212/ibm-data-acquisition-inventory-sales.html" class="subject">IBM completes Confluent acquisition to power real-time AI data</a></div><div><a href="/news/a20260318VL210/openai-aws-government-amazon-microsoft.html" class="subject">OpenAI teams with AWS to target US govt AI contracts</a></div><div><a href="/news/a20260318PD218/cpo-gtc-nvidia-2026-copper.html" class="subject">Nvidia GTC 2026: Nvidia charts optical-copper path</a></div><div><a href="/news/a20260318PD223/partnership-adoption-apac-supply-chain-manufacturing.html" class="subject">Foxconn and SAP forge strategic alliance to drive enterprise AI in APAC</a></div><div><a href="/news/a20260318PD219/military-anduril-software-startup-bloomberg.html" class="subject">US Army inks US$20 billion deal with Anduril, consolidating procurement to accelerate AI-driven military modernization</a></div><div><a href="/news/a20260318PD212/russia-loongson-x86-cpu-ic.html" class="subject">Russia reportedly turns to Loongson to escape x86 sanctions</a></div><div><a href="/news/a20260318VL207/mitsubishi-electric-foxconn-business-automotive-mitsubishi.html" class="subject">Mitsubishi Electric weighs stake sale in auto unit amid Foxconn talks</a></div><div><a href="/news/a20260317VL220/openai-data-capacity-infrastructure-data-center.html" class="subject">OpenAI shifts from building data centers to leasing cloud capacity</a></div><div><a href="/news/a20260318PD211/6g-taiwan-standards-president-technology.html" class="subject">Taiwan launches 6G industry forum</a></div><div><a href="/news/a20260318PD210/jensen-huang-infrastructure-chips-demand-cost.html" class="subject">In-depth: China's AI 'five-layer cake'&mdash; impressive on the outside, underbaked in the middle</a></div><div><a href="/news/a20260318VL200/fab-president-2025-manufacturing.html" class="subject">Tata Semiconductor head reportedly steps down amid fab build-out</a></div><div><a href="/news/a20260318PD205/syscom-computer-engineering-business-workforce-2026-expo.html" class="subject">Syscom presents AI as a new operational workforce, promising measurable business change</a></div><div><a href="/news/a20260318VL206/ipo-beijing-market.html" class="subject">China tightens Hong Kong IPO rules, curbs red-chip listings to stem capital outflows</a></div><div><a href="/news/a20260318PD204/2026-taiwan-smart-city-summit-expo-robot.html" class="subject">Taiwan smart city expo spotlights AI robotics across industries</a></div><div><a href="/news/a20260318PD201/apple-macbook-electronics-processor-2026.html" class="subject">Apple's low-cost MacBook Neo pressures consumer electronics amid rising memory costs</a></div><div><a href="/news/a20260318PD213/nvidia-2026-gtc-supply-chain-production.html" class="subject">Nvidia secures approvals and orders for H200 in China, restarts supply chain production</a></div><div><a href="/news/a20260318PD216/apple-mediatek-macbook-chips-revenue.html" class="subject">Apple adopts MediaTek Wi-Fi chip for MacBook Neo to save costs, say sources</a></div><div><a href="/news/a20260318VL204/intel-gaming-performance-mobile-workstation.html" class="subject">Intel unveils Core Ultra 200HX Plus processors with up to 8% gaming boost</a></div><div><a href="/news/a20260318PD208/nvidia-groq-2026-ai-chip-gtc.html" class="subject">Analysis: Is Nvidia's Groq deal the endgame for AI chip startups?</a></div><div><a href="/news/a20260318PD200/oppo-component-cost-expansion-smartphone.html" class="subject">Oppo seeks to offset component cost pressures with global expansion and premium push</a></div><div><a href="/news/a20260317PD232/hd-renewable-energy-storage-renewable-energy-2026.html" class="subject">HD Renewable Energy deepens presence in Japan's power market with 50MW Hokkaido energy storage project</a></div><div><a href="/news/a20260317VL205/production-gan-telecom-gallium-infrastructure.html" class="subject">India's Agnit Semiconductors raises US$2.6 million to commercialise GaN chips for telecom and power</a></div><div><a href="/news/a20260316PD206/bev-europe-vehicle-lithium-battery-2026.html" class="subject">The EV detour: Why carmakers are turning to range extenders to stay on track</a></div><div><a href="/news/a20260316PD209/nvidia-hardware-demand-deepseek-jensen-huang.html" class="subject">Analysis: How Nvidia is leveraging DeepSeek R1 surge to cement hardware&ndash;model domination</a></div><div><a href="/news/a20260316PD214/lcd-panel-demand-revenue.html" class="subject">Panel makers optimistic about 1Q26 despite February revenue declines</a></div><div><a href="/news/a20260316PD215/taiwan-uk-policy-2026-government.html" class="subject">Exclusive: UK's space shake-up puts Taiwan in the orbit of Britain's ambitions</a></div><div><a href="/news/a20260316PD224/ai-server-supply-chain-expansion-price-capacity.html" class="subject">Exclusive: AI server supply chain hits hidden stalemate as CSPs and manufacturers favor price hikes over expansion</a></div><div><a href="/news/a20260316PD227/data-center-optics-investment-growth-data.html" class="subject">AI data center optics boom lifts Ezconn; orders seen through 3Q26, margin floor set at 50%</a></div><div><a href="/news/a20260316PD229/laster-automotive-lighting-profit-shipments.html" class="subject">Laster Tech posts 4Q25 profit rebound, drives full-year turnaround</a></div><div><a href="/news/a20260316PD230/nvidia-training-data-center-chips-ip.html" class="subject">Chinese server maker Sugon unveils 400G AI fabric to rival Nvidia InfiniBand</a></div><div><a href="/news/a20260316PD231/chips-data-shanghai-startup-robotics.html" class="subject">Dreame rollout plan for five chips: chips for robots today, AI data centers in orbit tomorrow</a></div><div><a href="/news/a20260316PD237/data-manufacturing-demand-2025-ups.html" class="subject">AI boom lifts Changs Ascending as data centers seek reliable power</a></div><div><a href="/news/a20260316PD238/demand-foxconn-ai-server-market-csp.html" class="subject">Foxconn sees AI server market splitting GPU-ASIC 8:2 as CSP demand surges</a></div><div><a href="/news/a20260316VL206/shipments-sdc-price-competition-smartphone-display.html" class="subject">China price competition hits Samsung Display shipments while Korean OLED makers regain share</a></div><div><a href="/news/a20260317PD215/driver-ic-chipbond-packaging-growth-business.html" class="subject">Chipbond sets sights on SiPh and LPO for next phase of growth</a></div><div><a href="/news/a20260317PD213/taiwan-electronics-manufacturing-hardware-exports.html" class="subject">Surging US AI demand drives contract manufacturing fees higher for Taiwan electronics makers</a></div><div><a href="/news/a20260317PD207/meta-asic-broadcom-design-training.html" class="subject">Meta accelerates AI ASIC roll-out as Broadcom secures four-generation chip design deal</a></div><div><a href="/news/a20260317PD206/taiwan-president-2026-donald-trump-economic-growth.html" class="subject">Taiwan on track to outpace China's growth again in 2026</a></div><div><a href="/news/a20260316PD203/wistron-revenue-ai-server-sales-2025.html" class="subject">Wistron eyes sales model shift as AI server volume squeezes margins</a></div></div></div></div><div class="timeline-container"><div class="time-container"><div class="time-title">
                                <div class="month-date">
                                    <div>
                                        <p>Mar</p>
                                        <p>17</p>
                            ...
                            <div class="media-container"><div><a href="/news/a20260316VL208/industrial-robot-3d-vision-software-2026.html" class="subject">Mech-Mind Robotics champions eyes and brains for embodied AI industry</a></div><div><a href="/news/a20260316PD201/msi-gaming-ai-server-memory-chips-cost.html" class="subject">MSI to increase gaming product prices by up to 30% as memory costs spike</a></div><div><a href="/news/a20260317PD231/sk-group-chairman-hbm-demand-expansion.html" class="subject">Memory wafer shortage to persist until 2030; SK Group chairman says collaboration with Taiwanese firms is foundation of ecosystem</a></div><div><a href="/news/a20260317PD205/interbattery-2026-solid-state-battery-production-posco.html" class="subject">InterBattery 2026: Solid-state battery commercialization accelerates as Posco and EcoPro set mass production targets by year-end</a></div><div><a href="/news/a20260316PD202/ai-chip-ic-testing-capacity-equipment.html" class="subject">Hon Precision raises AI chip test capacity plan by 40% amid surging demand</a></div><div><a href="/news/a20260317PD225/innodisk-memory-module-cloud-ai-profit-earnings.html" class="subject">Innodisk February profit jumps as cloud, AI demand lifts earnings</a></div><div><a href="/news/a20260316VL204/2026-industrial-manufacturing-technology-expansion.html" class="subject">Korean AI trio takes industry spotlight&mdash;but can early promise survive the factory floor?</a></div><div><a href="/news/a20260317PD227/china-openclaw-ai-agent-cybersecurity-data.html" class="subject">China reins in OpenClaw surge, flags AI agent security risks</a></div><div><a href="/news/a20260317VL207/ai-llm-legal-2026.html" class="subject">MiroMind releases MiroThinker AI models focused on verifiable reasoning</a></div><div><a href="/news/a20260317VL204/dixon-foxlink-subsidiary-2026.html" class="subject">Dixon guarantees up to US$10 million for Padget Electronics' raw material purchases from Foxlink</a></div><div><a href="/news/a20260317PD201/mpi-testing-probe-card-profit-revenue-2025.html" class="subject">MPI posts record 2025 revenue and profit, expands probe card production in Taiwan</a></div><div><a href="/news/a20260317VL218/launch-software-security-hardware-rtx.html" class="subject">Nvidia GTC 2026: Nvidia unveils NemoClaw to accelerate autonomous agent deployment on OpenClaw</a></div><div><a href="/news/a20260317VL210/metax-gpu-china-cost-revenue-2025.html" class="subject">MetaX GPU push delivers growth, not profit, as losses hit US$560 million</a></div><div><a href="/news/a20260317VL215/nvidia-gtc-ai-agent-security-openclaw-2026.html" class="subject">Nvidia GTC 2026: NemoClaw adds security layer to OpenClaw AI agents</a></div><div><a href="/news/a20260317VL219/2026-gtc-samsung-hbm-micron.html" class="subject">HBM4 showdown at GTC 2026: SK Hynix, Samsung, and Micron battle for AI memory supremacy</a></div><div><a href="/news/a20260317PD223/nvidia-gtc-ai-agent-ai-inference-jensen-huang-samsung-2026.html" class="subject">Nvidia GTC 2026: Jensen Huang projects US$1 trillion inference market, LPU chip to be made by Samsung</a></div><div><a href="/news/a20260317PD200/foxconn-ai-demand-growth-2026.html" class="subject">Foxconn eyes steady growth in 2026 with 5-year AI transformation plan</a></div><div><a href="/news/a20260317VL217/capacity-meta-data-center-infrastructure-demand.html" class="subject">Meta and Nebius reach US$27B deal for AI infrastructure capacity as data center computing demand soars</a></div><div><a href="/news/a20260317PD218/siph-development-moea-taiwan-2026.html" class="subject">MOEA establishes high-speed silicon photonics verification lab to shorten development timelines</a></div><div><a href="/news/a20260317PD220/usa-australia-rare-earth-plant-price.html" class="subject">US Defense Department agrees on rare earths purchase with Lynas at Japan-matched floor price</a></div><div><a href="/news/a20260312VL206/samsung-2025-production-data-efficiency.html" class="subject">Samsung Electronics reports shifts in raw material costs and production output in fiscal 2025</a></div><div><a href="/news/a20260317PD216/samsung-dram-demand-production-2028.html" class="subject">Samsung cautious on memory expansion amid concerns over 2028 supply glut</a></div><div><a href="/news/a20260317VL214/gtc-nvidia-micron-hbm4-infrastructure-pcie-production.html" class="subject">Micron enters high-volume production of HBM4 and PCIe Gen6 SSDs for Nvidia platforms</a></div><div><a href="/news/a20260317VL206/apple-software-acquisition-adobe-revenue.html" class="subject">Apple acquires MotionVFX to strengthen creator tools and subscription strategy</a></div><div><a href="/news/a20260317VL212/taiwan-silicon-valley-economy-jensen-huang-gtc.html" class="subject">How Nvidia and Taiwan's co-engineering pact is fueling a US$1 trillion token economy</a></div><div><a href="/news/a20260317VL209/alibaba-qwen-development-business.html" class="subject">Alibaba forms 'Token Hub' unit to consolidate AI teams</a></div><div><a href="/news/a20260317PD203/gaming-games-console-memory-chips-chip-shortage-development.html" class="subject">AI-related impact on gaming industry goes beyond memory chip shortage</a></div><div><a href="/news/a20260317PD212/nand-emmc-mlc-supply-production.html" class="subject">eMMC shortage sends NAND prices soaring, with further gains ahead</a></div><div><a href="/news/a20260317PD211/supply-chain-expansion-taiwan-development-demand.html" class="subject">Taiwan's US$625 million drone ambition: Becoming the West's go-to supplier</a></div><div><a href="/news/a20260317PD209/ssfc-materials-taiwan-semiconductors-industrial.html" class="subject">Middle East conflict disrupts supply chains, Taiwan materials maker flags rare force majeure notices</a></div><div><a href="/news/a20260317PD202/middle-east-shipping-logistics-electronics-supply-chain.html" class="subject">As Middle East conflict further raises oil prices, air freight costs hit semiconductor supply chain</a></div><div><a href="/news/a20260317VL203/samsung-hbm4-nvidia-gtc-2026.html" class="subject">Nvidia GTC 2026: Samsung unveils HBM4E, showcasing comprehensive AI solutions, Nvidia partnership, and vision</a></div><div><a href="/news/a20260317VL208/openai-joint-venture-business-competition.html" class="subject">OpenAI reportedly exploring US$10B AI venture with private equity firms</a></div><div><a href="/news/a20260317PD204/china-genai-advertising.html" class="subject">China exposes GEO content poisoning grey market, raising new doubts over AI model trustworthiness</a></div><div><a href="/news/a20260316PD219/dram-memory-price-increase-revenue-2026.html" class="subject">Memory supply chain defies seasonality with contract price hikes in 1Q26</a></div><div><a href="/news/a20260316PD239/foxconn-ai-server-demand-growth-2025.html" class="subject">Foxconn eyes high double-digit AI server shipment growth in 1Q26</a></div><div><a href="/news/a20260316PD236/sk-hynix-samsung-ai-chip-growth-exports.html" class="subject">SK Hynix dethrones Samsung as South Korea's most desired employer</a></div><div><a href="/news/a20260316PD234/intel-nvidia-gtc-x86-cpu.html" class="subject">Intel joins GTC, eyes debut of co-developed x86 CPU with Nvidia</a></div><div><a href="/news/a20260316PD211/investigation-demand-inflation-taiwan-market.html" class="subject">Middle East conflict and Section 301 put manufacturers in a double bind</a></div><div><a href="/news/a20260316PD207/battery-energy-storage-vehicle-demand-2026.html" class="subject">Inter Battery 2026: Global battery market still centered on LFP</a></div><div><a href="/news/a20260316PD232/wpg-power-ic-demand-growth-2027.html" class="subject">WPG expects memory shortage to ease by 2027 as AI drives nearly half of computing products</a></div><div><a href="/news/a20260316VL209/7nm-manufacturing-development-hua-hong-semiconductor-shanghai.html" class="subject">China's Hua Hong reportedly develops 7nm process &mdash; breakthrough or bottleneck?</a></div><div><a href="/news/a20260316PD210/taiwan-exports-fedex-ups-demand.html" class="subject">Taiwan's exports to US hit record highs as FedEx and UPS expand cargo hubs</a></div><div><a href="/news/a20260317VL202/nvidia-outlook-demand-revenue-forecast.html" class="subject">Nvidia's US$1 trillion sales projection sparks debate over AI demand outlook</a></div><div><a href="/news/a20260317VL201/nvidia-gtc-2026-infrastructure-ceo.html" class="subject">Nvidia signals trillion dollar infrastructure shift at GTC 2026 keynote</a></div><div><a href="/news/a20260317VL200/nvidia-2026-gtc-infrastructure-ceo.html" class="subject">Nvidia GTC 2026: The agentic AI era arrives via full-stack infrastructure, open models, and simulation blueprints</a></div></div></div></div><div class="timeline-container"><div class="time-container"><div class="time-title">
                                <div class="month-date">
                                    <div>
                                        <p>Mar</p>
                                        <p>16</p>
                            ...
                            <div class="media-container"><div><a href="/news/a20260316VL210/taiwan-india-semiconductors-supply-chain-ic-manufacturing-incentives-2026.html" class="subject">India's 2026 budget targets semiconductor supply chain with five-year tax exemptions and near-zero import duties</a></div><div><a href="/news/a20260316PD235/asml-dutch-layoffs-equipment-2026.html" class="subject">ASML layoffs stall, leaving workers in limbo</a></div><div><a href="/news/a20260316PD233/sony-cis-apple-samsung-business.html" class="subject">Sony CIS yield issue raises Apple supply risks, opens door for Samsung</a></div><div><a href="/news/a20260316PD217/taiwan-chips-exports-shipments-supply-chain-2025.html" class="subject">AI boom fuels cargo surge at Taoyuan Airport's free trade zone</a></div><div><a href="/news/a20260316PD216/demand-ai-applications-expansion-osat-growth.html" class="subject">Taiwan OSAT firms log double-digit annual growth despite slow season</a></div><div><a href="/news/a20260316PD228/gogoro-chairman-electric-scooter.html" class="subject">Gogoro founder goes missing as reports on US$4.7M debt surfaces</a></div><div><a href="/news/a20260311PD207/esmt-memory-ddr3-design-ic.html" class="subject">ESMT sees DDR3 contract prices increase as supply tightens</a></div><div><a href="/news/a20260316VL207/bytedance-ai-copyright-legal.html" class="subject">ByteDance pauses global launch of AI video model under copyright clash</a></div><div><a href="/news/a20260316PD226/ic-design-europe-taiwan-production-2026.html" class="subject">Taiwan IC design emerges as top choice amid US-China tensions, key lifeline for Europe</a></div><div><a href="/news/a20260315PD200/wistron-talent-taiwan-nvidia-chairman.html" class="subject">Nvidia, Wistron lead charge in Taiwan's intensifying AI talent race</a></div><div><a href="/news/a20260316PD225/dram-hbm-competition-nand-flash-market-share.html" class="subject">DRAM prices surge 180% as HBM competition shifts to profitability</a></div><div><a href="/news/a20260312PD214/samsung-robot-robotics-manufacturing-hardware.html" class="subject">Samsung gives humanoid robots a hand with new dexterity-focused Hand Lab</a></div><div><a href="/news/a20260316PD220/tesla-ai-chip-wafer-fab-manufacturing-elon-musk.html" class="subject">Tesla's Terafab project launches in five days in bold push into AI chip manufacturing: 200bn AI chips annually?</a></div><div><a href="/news/a20260316PD223/price-ic-design-chips-market-12-inch.html" class="subject">IC design houses push 12-inch chips as 8-inch process price hikes loom</a></div><div><a href="/news/a20260312PD231/solar-sas-technology-market-solar-cell.html" class="subject">Solar wafer supplier Sino-American Silicon advances MWT BC cells for space power</a></div><div><a href="/news/a20260312VL215/2026-automation-security-fire-surveillance.html" class="subject">AW 2026:Sentient AI emerges as a new industrial safety layer</a></div><div><a href="/news/a20260312VL216/qwen-alibaba-talent-bytedance-competition.html" class="subject">Analysis: Alibaba Qwen talent exit highlights ByteDance's push in multimodal AI</a></div><div><a href="/news/a20260311PD219/automotive-global-pmx-taiwan-ai-server-equipment.html" class="subject">Beyond automotive: Global PMX expands AI server and chip equipment components capacity with new Vietnam plant</a></div><div><a href="/news/a20260311PD220/china-ai-agent-software-cybersecurity.html" class="subject">Analysis: OpenClaw sparks China's AI agent wave, economists see new compute boom</a></div><div><a href="/news/a20260311PD222/cmmt-polarizer-materials-business-packaging.html" class="subject">CMMT pushes ahead into semiconductor materials despite polarizer headwinds</a></div><div><a href="/news/a20260311PD225/cooling-copper-packaging-ai-server-testing.html" class="subject">GEM Services upgrades copper clip bonding for AI server dual-sided cooling</a></div><div><a href="/news/a20260313PD227/revenue-2025-demand-growth-2026.html" class="subject">Lotes tops US$1 billion in 2025 revenue on rising demand for high-value server connectors</a></div><div><a href="/news/a20260316PD205/ai-server-liquid-cooling-water-2026-shipments.html" class="subject">Walrus Pump sees AI server liquid cooling driving tech pump shipments by the second quarter of 2026</a></div><div><a href="/news/a20260316VL205/usa-ai-chip-exports-policy-regulation.html" class="subject">US withdraws draft for rule requiring approval for AI chip exports anywhere in the world</a></div><div><a href="/news/a20260316PD221/f1-byd-ev-automotive-ice-energy-management-2026.html" class="subject">Analysis: BYD eyes F1 entry as it moves from gas engines to electric muscle</a></div><div><a href="/news/a20260316PD218/humanoid-robotics-2026.html" class="subject">EW 2026: addressing eyes &amp; hands challenges in robotics</a></div><div><a href="/news/a20260316PD222/nvidia-gtc-jensen-huang-ai-agent-chips.html" class="subject">Nvidia GTC 2026: Jensen Huang targets AI bubble fears, unveils next-generation chips</a></div><div><a href="/news/a20260316PD213/samsung-nexchip-wafer-price-increase-2026.html" class="subject">Chip inflation spreads as Samsung, Nexchip raise foundry prices and material costs surge</a></div><div><a href="/news/a20260316VL201/aws-cerebras-ai-inference-ai-chip.html" class="subject">AWS and Cerebras collaborate on faster AI inference for Amazon Bedrock</a></div><div><a href="/news/a20260316PD212/nvidia-jensen-huang-ai-infrastructure-2026.html" class="subject">Commentary: Nvidia CEO outlines new AI infrastructure vision ahead of GTC 2026</a></div><div><a href="/news/a20260316PD200/vis-nexchip-capacity-demand-price-2025.html" class="subject">Vanguard to follow Nexchip with foundry price hikes starting in April</a></div><div><a href="/news/a20260316VL202/digitimes-weekly-news-roundup-nand-memory-chips-price-2026.html" class="subject">Weekly news roundup: Memory crunch, AI supply chains, new manufacturing hubs</a></div><div><a href="/news/a20260316PD208/hybrid-ev-esg-performance.html" class="subject">New F1 era begins with Mercedes dominance and technical debate</a></div><div><a href="/news/a20260316VL200/micron-acquisition-taiwan-psmc-cleanroom.html" class="subject">Micron completes acquisition of PSMC's Tongluo P5 site in Taiwan</a></div><div><a href="/news/a20260316PD204/foxconn-capacity-ai-server-data-center-infrastructure.html" class="subject">Foxconn's investor briefing could signal major shifts in AI server supply, capacity and data center infrastructure</a></div><div><a href="/news/a20260313VL219/demand-ai-server-ccl-pcb-revenue.html" class="subject">AI server tracker: AI server boom drives demand for PCB, CCL and interconnect suppliers</a></div><div><a href="/news/a20260311PD230/visionox-equipment-production-sdc-panel.html" class="subject">Visionox starts 8.6-gen OLED equipment orders, intensifying China&ndash;Korea race for IT displays</a></div><div><a href="/news/a20260312PD223/taiwan-revenue-nstc-government-2025.html" class="subject">Taiwan's science park formula, now available for export to US</a></div><div><a href="/news/a20260312VL209/openai-sora-chatgpt-competition.html" class="subject">OpenAI rolls Sora into ChatGPT, seeing more in store for engagement</a></div><div><a href="/news/a20260311PD231/component-chicony-demand-pc-keyboard.html" class="subject">Taiwan keyboard and camera module maker Chicony turns to Edge AI vision to counter weaker PC demand</a></div><div><a href="/news/a20260313VL215/ai-server-demand-revenue-supply-chain-taiwan-monthly-tracker-taiwan.html" class="subject">AI server tracker: AI infrastructure demand lifts Taiwan foundry and ODM/EMS revenues despite seasonal dip</a></div><div><a href="/news/a20260313VL212/taiwan-industrial-anthropic-tsmc-ban.html" class="subject">Interview: Taiwan's industrial spirit &mdash; the hidden geopolitical layer</a></div><div><a href="/news/a20260313VL213/india-roundup-ic-manufacturing-osat-production-smartphone-2026.html" class="subject">India roundup: A reality check of chipmaking dream</a></div><div><a href="/news/a20260313VL200/umc-production-partnership-manufacturing-infrastructure.html" class="subject">HyperLight, UMC, and Wavetek form foundry partnership for high-volume TFLN chiplet production</a></div><div><a href="/news/a20260313PD234/robotics-robot-chairman-taiwan-manufacturing.html" class="subject">The next robotics battleground is in the fingertips</a></div><div><a href="/news/a20260313PD228/yen-sun-automotive-electronics-liquid-cooling-revenue-2026.html" class="subject">Y.S. Tech expects Renwu plant ramp to boost 2026 capacity and high-end IT revenue</a></div><div><a href="/news/a20260313PD209/revenue-robotics-2026-2025-growth.html" class="subject">Aurotek's robotics pivot drives record revenue, targets double-digit growth</a></div><div><a href="/news/a20260313PD208/spacex-2025-partnership-technology-wafer.html" class="subject">Interview: Filtronic wins SpaceX contract, looks to Taiwan for next partnerships</a></div><div><a href="/news/a20260313PD205/global-pmx-ai-server-medical-revenue-2026.html" class="subject">Global PMX shifts revenue mix toward semiconductor and medical businesses, projecting stronger profits in 2026</a></div><div><a href="/news/a20260313PD203/2026-himax-display-technology-subsidiary.html" class="subject">Himax showcases palm vein authentication and WiseEye at Embedded World 2026</a></div></div></div></div><div class="timeline-container"><div class="time-container"><div class="time-title">
                                <div class="month-date">
                                    <div>
                                        <p>Mar</p>
                                        <p>15</p>
                            ...
                            <div class="media-container"><div><a href="/news/a20260311PD235/growth-leo-supply-chain-equipment-manufacturing.html" class="subject">SpeedTech enters LEO satellite supply chain, eyes double-digit growth</a></div><div><a href="/news/a20260313PD210/pcb-price-supply-chain-cost-materials.html" class="subject">PCB supply chains feel the heat of Middle East</a></div><div><a href="/news/a20260312VL200/uk-startup-industrial-expo-university.html" class="subject">After Space-Comm: How global alliances and pension reform are scaling UK space</a></div><div><a href="/news/a20260311PD201/asus-pc-price-shipments-revenue.html" class="subject">Asus warns PC shipments to fall as memory shortages and price rises reshape supply and pricing</a></div><div><a href="/news/a20260311PD218/2026-microchip-germany-efficiency.html" class="subject">Think like an octopus: Microchip COO makes the case for distributed edge AI</a></div><div><a href="/news/a20260312PD235/revenue-zhen-ding-pcb-2026-demand.html" class="subject">Zhen Ding sees AI products near 70% of revenue, sets NT$100 billion capex for 2 years</a></div><div><a href="/news/a20260311PD210/automotive-market-revenue-component-production.html" class="subject">Kwang-Hwa's North American revenue surges 25% as overseas expansion offsets China pressure</a></div><div><a href="/news/a20260312PD202/vehicle-zf-automotive-europe-2026.html" class="subject">SiliconAuto's MCU debut could reshape compute allocation in vehicle platforms</a></div><div><a href="/news/a20260313PD220/odm-taiwan-revenue-growth-ems.html" class="subject">AWS ASIC servers enter mass production in 2Q26, lifting Taiwan ODM outlook</a></div><div><a href="/news/a20260313PD226/niching-testing-packaging-revenue-2026.html" class="subject">Niching sees AI-driven thermal products lift early 2026 revenue despite Lunar New Year slowdown</a></div></div></div></div><div class="timeline-container"><div class="time-container"><div class="time-title">
                                <div class="month-date">
                                    <div>
                                        <p>Mar</p>
                                        <p>14</p>
                            ...
                            <div class="media-container"><div><a href="/news/a20260313PD236/2026-ai-server-demand-revenue-wpg.html" class="subject">AI server boom lifts WPG Holdings to record February revenue</a></div><div><a href="/news/a20260313PD231/e-ink-e-paper-esl-revenue-demand-2026.html" class="subject">E Ink sees record revenue, profit in 2026 as e-paper demand grows</a></div><div><a href="/news/a20260311PD224/equipment-capacity-revenue-demand-production.html" class="subject">TsangYow accelerates NEV and semiconductor equipment expansion with SEA capacity</a></div><div><a href="/news/a20260311VL205/2026-infrastructure-germany-policy.html" class="subject">US leads global AI readiness ranking, Asia claims half of top ten</a></div><div><a href="/news/a20260311PD239/revenue-materials-ccl-growth-ai-server.html" class="subject">Wah Lee sees record revenue in 1H26 driven by AI server orders, CCL substrate growth</a></div><div><a href="/news/a20260313PD214/fedex-taiwan-logistics-capacity-infrastructure.html" class="subject">FedEx expands Taiwan hub to meet AI and semiconductor logistics surge</a></div><div><a href="/news/a20260311PD223/browave-cpo-demand-capacity-data-center.html" class="subject">Browave eyes 10x monthly CPO capacity surge by 2027 amid AI data center demand</a></div><div><a href="/news/a20260312PD233/southern-taiwan-science-park-revenue-2025-demand-2024.html" class="subject">Southern Taiwan Science Park revenue nears NT$3 trillion in 2025</a></div><div><a href="/news/a20260313VL216/demand-revenue-2026-2025-chips.html" class="subject">AI boom lifts global foundry revenue to record US$169.5bn, demand risks surface for 2026</a></div><div><a href="/news/a20260313PD232/innocare-x-ray-healthcare-war-demand.html" class="subject">Portable X-ray detector maker InnoCare expands global network as US-Iran war triggers urgent orders</a></div><div><a href="/news/a20260313PD235/samsung-galaxy-flagship-smartphone-sales-taiwan.html" class="subject">Samsung S26 sales in Taiwan rise 25%, 1TB model accounts for 15% of orders</a></div><div><a href="/news/a20260312PD207/m31-revenue-2025-eda-profit.html" class="subject">M31's 2025 results show revenue lift but profit still weigh down by EDA costs and currency losses</a></div><div><a href="/news/a20260313VL220/military-ai-startup-drone-interview.html" class="subject">Interview: EdgeRunner AI CEO on navigating ethical and strategic row over military AI</a></div><div><a href="/news/a20260312PD221/hbm-demand-revenue-data-nanya-technology.html" class="subject">DRAM maker Nanya's custom AI memory gains traction with 10+ clients</a></div><div><a href="/news/a20260313PD224/innolux-oversupply-panel-market-plant.html" class="subject">Innolux puts Fab 2 and Fab 5 on sale as panel glut bites</a></div><div><a href="/news/a20260313PD222/taiwan-usa-government-legal-investigation.html" class="subject">Taiwan braces for Section 301 probes after US Supreme Court ruling, leveraging prior pacts to cushion impact</a></div><div><a href="/news/a20260313PD223/2026-interbattery-solid-state-battery-production-technology.html" class="subject">South Korean battery makers charge up InterBattery 2026 with solid-state push</a></div><div><a href="/news/a20260313PD215/ddr4-ddr3-winbond-dram-capacity.html" class="subject">Winbond raises DDR3 prices to match DDR4, accelerates shift to DDR4</a></div><div><a href="/news/a20260313PD206/intelliepi-revenue-2026-growth-2025.html" class="subject">IntelliEPI's optical products drive revenue shift, boost margins, sees forecasts faster growth for 2026</a></div><div><a href="/news/a20260313PD202/revenue-growth-robotics-2026-manufacturing.html" class="subject">Pan-International pivots to AI servers and robotics in pursuit of double-digit growth</a></div></div></div></div></div>
    		    <div class="col col-right">
                <div class="sidebar-item" id="stid"> 
                    <div id="banner_mid-md" class="mid-ad tablet-show"></div>                    <div id="AAd" class="square-ad"><div class="text-center"><div class="clclgjs" rel="92667"><a href='/webad/cnv.asp?Seq=92667' target='_blank'><img src="https://img.digitimes.com/ad/en_20260210_asia_bigbutton.jpg" class="awh" style="max-width:336px;" border="0" alt="Research Report Database" /></a></div></div></div>                    <div class="subject-title"><a class="text" href="/biz/">BIZ FOCUS</a></div><div class="display-1"><a class="main-photo" href="/news/a20260206PR200.html?chid=9" style="background-image: url(/newsshow/20260206PR200_files/4_r.jpg)"><div class="title-frame"><div class="date"><svg class="icon"><use xlink:href="#clock-icon-white"></use></svg>Feb 9, 08:00</div><div class="title">iCatch and DXOMARK Establish Taiwan's First Next Generation Imaging Laboratory</div></div></a><div class="related-frame"><a class="item-frame" href="/news/a20260205PR200.html?chid=9"><div class="date"><svg class="icon"><use xlink:href="#clock-icon"></use></svg>Friday 6 February 2026</div><div class="title">2026 Market Outlook: Key Opportunities & Risks to Watch</div></a><a class="item-frame" href="/news/a20260204PR200.html?chid=9"><div class="date"><svg class="icon"><use xlink:href="#clock-icon"></use></svg>Thursday 5 February 2026</div><div class="title">Attopsemi Scales I-fuse Technology to 7nm following 12nm Silicon Success</div></a><a class="item-frame" href="/news/a20260203PR200.html?chid=9"><div class="date"><svg class="icon"><use xlink:href="#clock-icon"></use></svg>Wednesday 4 February 2026</div><div class="title">Teaching Machines to Feel the World TOUCH Lab Redefines Sensing</div></a></div></div>                    <div id="BAd" class="square-ad"><div class="text-center"><div class="clclgjs" rel="95213"><a href='/webad/cnv.asp?Seq=95213' target='_blank'><img src="https://img.digitimes.com/ad/en_20250923_b2b3_bigbutton.jpg" class="awh" style="max-width:336px;" border="0" alt="marketing" /></a></div></div></div>                    <ul class="nav nav-tabs tab-frame d-flex flex-nowrap"><li class="nav-item"><a class="nav-link text active" id="top-news" data-toggle="tab" href="#topnews" role="tab" aria-controls="topnews" aria-selected="true">MOST-READ</a></li><li class="nav-item"><a class="nav-link text" id="7-days" data-toggle="tab" href="#calendar" role="tab" aria-controls="calendar" aria-selected="true">7 DAYS NEWS</a></li></ul><div class="tab-content" id="topcontent"><div class="tab-pane fade show active" id="topnews" role="tabpanel" aria-labelledby="topnews-tab"><div class="range-news"><ul><li class="item"><a class="link" href="/news/a20260304PD230/tsmc-price-profit-semiconductor-industry-cost.html">TSMC leads foundry price hikes as second-tier firms see profit rebound</a></li><li class="item"><a class="link" href="/news/a20260310PD225/packaging-pcb-nvidia-capacity-development.html">Nvidia narrows CoWoP PCB partners to three amid advanced packaging crunch</a></li><li class="item"><a class="link" href="/news/a20260303PD201/dram-hbm-expansion-nvidia-gtc-2026.html">DRAM prices to surge up to 70% in 2Q26; Nvidia GTC 2026 ignites AI memory rally</a></li><li class="item"><a class="link" href="/news/a20260226PD210/nvidia-gpu-gtc-3d-ic-sk-hynix.html">Is Nvidia's GTC mystery chip a 3D IC with memory stacked on the GPU?</a></li><li class="item"><a class="link" href="/news/a20260306PD218/intel-ic-substrate-investment-tsmc-capacity.html">Intel&rsquo;s EMIB gains traction as CoWoS alternative, reviving IC substrate investment</a></li></ul></div></div><div class="tab-pane fade" id="calendar" role="tabpanel" aria-labelledby="calendar-tab"><div class="range-news"><ul><li class="item"><a class="link" href="/news/a20260319PD216/packaging-intel-ai-chip-tsmc-samsung.html">Intel pushes large-area AI packaging to close foundry gap</a></li><li class="item"><a class="link" href="/news/a20260317VL211/technology-photonics-infrastructure-ceo.html">Lumotive creates world's first 2D photonic beamforming chip</a></li><li class="item"><a class="link" href="/news/a20260319PD202/price-supply-chain-market-demand-retail.html">Analysis: Memory price swings leave e-reader supply chain in the red</a></li><li class="item"><a class="link" href="/news/a20260319PD213/semiconductors-materials-gallium-gases-cost-middle-east.html">China curbs, Middle East tensions drive surge in chip material risks from gallium to helium</a></li><li class="item"><a class="link" href="/news/a20260319VL206/taiwan-taipei-hbm-war.html">The HBM paradox: why Taipei and Seoul can't afford a diplomatic cold war</a></li></ul><div class="wrapper"><a class="more-btn" href="/calendar.asp?d=7d&dt_ref=tabs">Full list</a></div></div></div></div>                    <div class="sidebar-sticky">
                        <div class="subject-title"><a class="text" href="/reports/index.asp?view=0">RESEARCH INSIGHTS</a></div><a class="display-3-frame mb-20 pb-10" href="/news/a20260113VL209.html?chid=2"><img class="photo lazy" data-src="https://img.digitimes.com/newsshow/20260113vl209_files/4_r.jpg"><div class="title">Weekly research roundup: Qualcomm's AI strategy, memory giants and updated 2026 smartphone outlook</div></a>                    </div>
                </div>
    		</div>
    	</div>
    </div>
