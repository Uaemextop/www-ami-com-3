...
<html lang="en">
  <head>
    ...
    <meta name="Date" content="2026/03/20 08:34:40" />
    ...
    <script language="JavaScript" type="text/javascript">
      $(function() {
        ...
        latest_reports_cards.forEach(card => {
          const title = card.querySelector('.title')
          const title_length = card.querySelector('.title').innerText.length
          if (title_length < 50) {
            title.classList.add('large-text');
        ...
        const sliders = document.querySelectorAll('.swiper .swiper-wrapper .swiper-slide')
        sliders.forEach((s) => {
          const p = s.querySelector('.slide-content .wrapper p')
          const p_length = p.innerText.length
          console.log(p_length)
          if (p_length < 150) {
            p.classList.add('large-text')
          } else if (p_length < 190) {
    ...
    .analysts-block .container .card-analyst .analyst-content-block .analyst-name, .analysts-block .container .card-analyst .analyst-content-block .analyst-brief-intro {text-align: center;}
    .intro-color{color: black !important;}
    .analysts-block .container .card-analyst{padding: 20px 68px 20px !important;}
    ...
    <!--JS/CSS-->
    <script defer language="JavaScript" type="text/javascript" src="./js/bradcrumble.js">
    </script>
    <script defer src="./js/meet-analysts.js"></script>
    <link rel="stylesheet" type="text/css" media="all" href="styles/style.css"/>
    <script type="text/javascript" src="../Include/assets/js/core.js"></script>
    ...
    <div class="reports-breadcrumbs">
        <div class="container">
            <ul>
                ...
                <li class="item"><a class="link" href="research.php">Meet the Analysts</a></li>
            </ul>
        </div>
    </div>

    <!--analysts-block-->
    <div class="analysts-block">
        <div class="container" id="meet"><a class="card-analyst" href="analysts.php?rid=734"><img src="https://img.digitimes.com/tw/x/img/viewpoint/orange/b40904a.jpg" class="analyst-portrait"><div class="analyst-content-block"><div class="analyst-name intro-color">Jo Kim</div><div class="analyst-brief-intro intro-color">Analyst</div></div></a><a class="card-analyst" href="analysts.php?rid=702"><img src="https://img.digitimes.com/tw/x/img/viewpoint/orange/b20801a.jpg" class="analyst-portrait"><div class="analyst-content-block"><div class="analyst-name intro-color">Jason Tsai</div><div class="analyst-brief-intro intro-color">Deputy Director</div></div></a><a class="card-analyst" href="analysts.php?rid=713"><img src="https://img.digitimes.com/tw/x/img/viewpoint/orange/a80504a.jpg" class="analyst-portrait"><div class="analyst-content-block"><div class="analyst-name intro-color">Yen Chou</div><div class="analyst-brief-intro intro-color">Analyst</div></div></a><a class="card-analyst" href="analysts.php?rid=730"><img src="https://img.digitimes.com/tw/x/img/viewpoint/orange/b30906a.jpg" class="analyst-portrait"><div class="analyst-content-block"><div class="analyst-name intro-color">Richard Chen</div><div class="analyst-brief-intro intro-color">Analyst</div></div></a><a class="card-analyst" href="analysts.php?rid=731"><img src="https://img.digitimes.com/tw/x/img/viewpoint/orange/b30909a.jpg" class="analyst-portrait"><div class="analyst-content-block"><div class="analyst-name intro-color">Angel Wang</div><div class="analyst-brief-intro intro-color">Analyst</div></div></a><a class="card-analyst" href="analysts.php?rid=726"><img src="https://img.digitimes.com/tw/x/img/viewpoint/orange/b21102a.jpg" class="analyst-portrait"><div class="analyst-content-block"><div class="analyst-name intro-color">Kaylee Chiu</div><div class="analyst-brief-intro intro-color">Analyst</div></div></a><a class="card-analyst" href="analysts.php?rid=703"><img src="https://img.digitimes.com/tw/x/img/viewpoint/orange/980710a.jpg" class="analyst-portrait"><div class="analyst-content-block"><div class="analyst-name intro-color">Tom Lo</div><div class="analyst-brief-intro intro-color">Deputy Director</div></div></a><a class="card-analyst" href="analysts.php?rid=732"><img src="https://img.digitimes.com/tw/x/img/viewpoint/orange/b31203a.jpg" class="analyst-portrait"><div class="analyst-content-block"><div class="analyst-name intro-color">Vanessa Liao</div><div class="analyst-brief-intro intro-color">Analyst</div></div></a><a class="card-analyst" href="analysts.php?rid=710"><img src="https://img.digitimes.com/tw/x/img/viewpoint/orange/941204a.jpg" class="analyst-portrait"><div class="analyst-content-block"><div class="analyst-name intro-color">Jason Yang</div><div class="analyst-brief-intro intro-color">Analyst</div></div></a><a class="card-analyst" href="analysts.php?rid=711"><img src="https://img.digitimes.com/tw/x/img/viewpoint/orange/a01205a.jpg" class="analyst-portrait"><div class="analyst-content-block"><div class="analyst-name intro-color">Benson  Wu</div><div class="analyst-brief-intro intro-color">Senior Analyst</div></div></a><a class="card-analyst" href="analysts.php?rid=706"><img src="https://img.digitimes.com/tw/x/img/viewpoint/orange/960405a.jpg" class="analyst-portrait"><div class="analyst-content-block"><div class="analyst-name intro-color">Luke  Lin</div><div class="analyst-brief-intro intro-color">Senior Analyst</div></div></a><a class="card-analyst" href="analysts.php?rid=704"><img src="https://img.digitimes.com/tw/x/img/viewpoint/orange/a01111a.jpg" class="analyst-portrait"><div class="analyst-content-block"><div class="analyst-name intro-color">Jim Hsiao </div><div class="analyst-brief-intro intro-color">Senior Analyst</div></div></a><a class="card-analyst" href="analysts.php?rid=735"><img src="https://img.digitimes.com/tw/x/img/viewpoint/orange/b40507a.jpg" class="analyst-portrait"><div class="analyst-content-block"><div class="analyst-name intro-color">Richard Chung</div><div class="analyst-brief-intro intro-color">Analyst</div></div></a><a class="card-analyst" href="analysts.php?rid=712"><img src="https://img.digitimes.com/tw/x/img/viewpoint/orange/a60303a.jpg" class="analyst-portrait"><div class="analyst-content-block"><div class="analyst-name intro-color">Ashely Huang</div><div class="analyst-brief-intro intro-color">Analyst</div></div></a><a class="card-analyst" href="analysts.php?rid=736"><img src="https://img.digitimes.com/tw/x/img/viewpoint/orange/b40905a.jpg" class="analyst-portrait"><div class="analyst-content-block"><div class="analyst-name intro-color">Rannie Wang</div><div class="analyst-brief-intro intro-color">Analyst</div></div></a><a class="card-analyst" href="analysts.php?rid=714"><img src="https://img.digitimes.com/tw/x/img/viewpoint/orange/a80602a.jpg" class="analyst-portrait"><div class="analyst-content-block"><div class="analyst-name intro-color">Chiawen Chang</div><div class="analyst-brief-intro intro-color">Analyst</div></div></a><a class="card-analyst" href="analysts.php?rid=715"><img src="https://img.digitimes.com/tw/x/img/viewpoint/orange/a80702a.jpg" class="analyst-portrait"><div class="analyst-content-block"><div class="analyst-name intro-color">Stella Weng</div><div class="analyst-brief-intro intro-color">Analyst</div></div></a><a class="card-analyst" href="analysts.php?rid=717"><img src="https://img.digitimes.com/tw/x/img/viewpoint/orange/a80708a.jpg" class="analyst-portrait"><div class="analyst-content-block"><div class="analyst-name intro-color">Eric Chen </div><div class="analyst-brief-intro intro-color">Analyst</div></div></a><a class="card-analyst" href="analysts.php?rid=707"><img src="https://img.digitimes.com/tw/x/img/viewpoint/orange/a91202a.jpg" class="analyst-portrait"><div class="analyst-content-block"><div class="analyst-name intro-color">Wing Huang</div><div class="analyst-brief-intro intro-color">Analyst</div></div></a><a class="card-analyst" href="analysts.php?rid=720"><img src="https://img.digitimes.com/tw/x/img/viewpoint/orange/b10102a.jpg" class="analyst-portrait"><div class="analyst-content-block"><div class="analyst-name intro-color">Ricky Tu</div><div class="analyst-brief-intro intro-color">Analyst</div></div></a><a class="card-analyst" href="analysts.php?rid=716"><img src="https://img.digitimes.com/tw/x/img/viewpoint/orange/a80703a.jpg" class="analyst-portrait"><div class="analyst-content-block"><div class="analyst-name intro-color">Jim Chien</div><div class="analyst-brief-intro intro-color">Analyst</div></div></a><a class="card-analyst" href="analysts.php?rid=723"><img src="https://img.digitimes.com/tw/x/img/viewpoint/orange/b10601a.jpg" class="analyst-portrait"><div class="analyst-content-block"><div class="analyst-name intro-color">Jasper Jiang</div><div class="analyst-brief-intro intro-color">Analyst</div></div></a><a class="card-analyst" href="analysts.php?rid=724"><img src="https://img.digitimes.com/tw/x/img/viewpoint/orange/b20101a.jpg" class="analyst-portrait"><div class="analyst-content-block"><div class="analyst-name intro-color">Aaron Chen</div><div class="analyst-brief-intro intro-color">Analyst</div></div></a><a class="card-analyst" href="analysts.php?rid=721"><img src="https://img.digitimes.com/tw/x/img/viewpoint/orange/b10403a.jpg" class="analyst-portrait"><div class="analyst-content-block"><div class="analyst-name intro-color">Jin Pai</div><div class="analyst-brief-intro intro-color">Analyst</div></div></a><a class="card-analyst" href="analysts.php?rid=719"><img src="https://img.digitimes.com/tw/x/img/viewpoint/orange/b01004a.jpg" class="analyst-portrait"><div class="analyst-content-block"><div class="analyst-name intro-color">Eva Lin</div><div class="analyst-brief-intro intro-color">Analyst</div></div></a><a class="card-analyst" href="analysts.php?rid=709"><img src="https://img.digitimes.com/tw/x/img/viewpoint/orange/b20306a.jpg" class="analyst-portrait"><div class="analyst-content-block"><div class="analyst-name intro-color">Zouhao Shen</div><div class="analyst-brief-intro intro-color">Analyst</div></div></a><a class="card-analyst" href="analysts.php?rid=708"><img src="https://img.digitimes.com/tw/x/img/viewpoint/orange/b10602a.jpg" class="analyst-portrait"><div class="analyst-content-block"><div class="analyst-name intro-color">Mark Yee</div><div class="analyst-brief-intro intro-color">Analyst</div></div></a><a class="card-analyst" href="analysts.php?rid=725"><img src="https://img.digitimes.com/tw/x/img/viewpoint/orange/b20902a.jpg" class="analyst-portrait"><div class="analyst-content-block"><div class="analyst-name intro-color">Brandon Fang</div><div class="analyst-brief-intro intro-color">Analyst</div></div></a><a class="card-analyst" href="analysts.php?rid=733"><img src="https://img.digitimes.com/tw/x/img/viewpoint/orange/b40201a.jpg" class="analyst-portrait"><div class="analyst-content-block"><div class="analyst-name intro-color">C.Y.  Yao</div><div class="analyst-brief-intro intro-color">Analyst</div></div></a><a class="card-analyst" href="analysts.php?rid=701"><img src="https://img.digitimes.com/tw/x/img/viewpoint/orange/921202a.jpg" class="analyst-portrait"><div class="analyst-content-block"><div class="analyst-name intro-color">Jessie  Lin</div><div class="analyst-brief-intro intro-color">Senior Analyst</div></div></a><a class="card-analyst" href="analysts.php?rid=728"><img src="https://img.digitimes.com/tw/x/img/viewpoint/orange/b30401a.jpg" class="analyst-portrait"><div class="analyst-content-block"><div class="analyst-name intro-color">Henry Chang</div><div class="analyst-brief-intro intro-color">Analyst</div></div></a><a class="card-analyst" href="analysts.php?rid=729"><img src="https://img.digitimes.com/tw/x/img/viewpoint/orange/b30404a.jpg" class="analyst-portrait"><div class="analyst-content-block"><div class="analyst-name intro-color">Nick Chen</div><div class="analyst-brief-intro intro-color">Analyst</div></div></a><a class="card-analyst" href="analysts.php?rid=705"><img src="https://img.digitimes.com/tw/x/img/viewpoint/orange/870804a.jpg" class="analyst-portrait"><div class="analyst-content-block"><div class="analyst-name intro-color">Tony Huang</div><div class="analyst-brief-intro intro-color">Director</div></div></a><a class="card-analyst" href="analysts.php?rid=722"><img src="https://img.digitimes.com/tw/x/img/viewpoint/orange/b10502a.jpg" class="analyst-portrait"><div class="analyst-content-block"><div class="analyst-name intro-color">Sabrina Yu</div><div class="analyst-brief-intro intro-color">Analyst</div></div></a><a class="card-analyst" href="analysts.php?rid=727"><img src="https://img.digitimes.com/tw/x/img/viewpoint/orange/b21201a.jpg" class="analyst-portrait"><div class="analyst-content-block"><div class="analyst-name intro-color">Joyce Chen</div><div class="analyst-brief-intro intro-color">Analyst</div></div></a></div>
    </div>
