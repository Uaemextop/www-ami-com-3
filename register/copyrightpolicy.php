...
<head>
    ...
    <meta name="Description" content="All content published on the DIGITIMES website are protected by the copyright laws of the R.O.C., international copyright laws and laws related to intellectual property rights."/>
    <meta name="Keywords" content="DIGITIMES, Taiwan, daily news, information, technology, copyright policy, laws, policy, property, rights, publication, Asia, Chinese, English"/>
    <meta name="Pragma" content="no_cache"/>
    <title>Copyright policy - DIGITIMES</title>
  ...
  <div class="mobile-nav" id="mobile-nav">
    ...
    <div class="content-frame">
      ...
      <div class="socail-frame">
	    ...
	    <div class="my-container">
	    	<div class="adrow">
                <div id="banner" class="adcol-8"><div class="text-center"><div class="clclgjs" rel="96835"><a href='/webad/cnv.asp?Seq=96835' target='_blank'><img src="https://img.digitimes.com/ad/en_20260302_newpowerww_leaderboard.gif" class="awh" style="max-width:728px;" border="0" alt="New Power WorldWide 2026" /></a></div></div></div><div id="banner_mid" class="adcol-4"><div class="text-center"><div class="clclgjs" rel="95210"><a href='/webad/cnv.asp?Seq=95210' target='_blank'><img src="https://img.digitimes.com/ad/en_20250923_b2b3_button336x90.jpg" class="awh" style="max-width:336px;" border="0" alt="marketing" /></a></div></div></div>	    	</div>
	    </div>
    </div>
        <div class="gotop">
    ...
    <div class="my-container">	
    	<div class="information-frame" id="privacy">
            <div class="main-title">Copyright Policy</div>
    		<div class="content">
          <p class="CenterText">Last Updated: September 5, 2023</p>
          <div class="content-box">
            <p class="toc-up">Table of Contents</p>
            <ul class="custom-list">
              <li><a href="#protection">Content and Copyright Protection</a></li>
              <li><a href="#compensation">Compensation and Legal Consequences</a></li>
              <li><a href="#unauthorized">Unauthorized Use</a></li>
              <li><a href="#DMCA">DMCA Notice and Copyright Complaint Mechanism</a></li>
              <li><a href="#user-generated">User-Generated Content</a></li>
              <li><a href="#rules">Rules for Reposting and Sharing</a></li>
              <li><a href="#links">Third-Party Links</a></li>
              <li><a href="#interpretation">Applicable Law and Interpretation</a></li>
            </ul>
          </div>
          <div class="content-box">
            <a id="protection" name="protection" class="hideJump"></a>
            <p class="anchor">1. Content and Copyright Protection</p>
            <p>All content published on the DIGITIMES website, such as articles, photos, images, illustrations, audio, video, files, website layout and design, are protected by the laws of the Republic of China (Taiwan), international copyright laws, and relevant intellectual property laws. This intellectual property, owned either by DIGITIMES or its collaborative content providers, includes but is not limited to trademarks, patents, copyright, trade secrets, and proprietary technology.</p>
          </div>
          <div class="content-box">
            <a id="compensation" name="compensation" class="hideJump"></a>
            <p class="anchor">2. Compensation and Legal Consequences</p>
            <p>Violation of the copyright policy may result in legal consequences, including but not limited to fines, lawsuits, etc. Inadvertent violation of copyright, such as not realizing a piece of content is copyrighted, will also be regarded as illegal.</p>
          </div>
          <div class="content-box">
            <a id="unauthorized" name="unauthorized" class="hideJump"></a>
            <p class="anchor">3. Unauthorized Use</p>
            <p>Without explicit authorization, users must not alter, publish, transmit, sell, recreate, edit, disseminate, display, or exhibit any part or the entirety of the content and services provided on this website.</p>
          </div>
          <div class="content-box">
            <a id="DMCA" name="DMCA" class="hideJump"></a>
            <p class="anchor">4. DMCA Notice and Copyright Complaint Mechanism</p>
            <p>We comply with the Digital Millennium Copyright Act (DMCA). If you are a copyright owner and believe your rights have been violated, you can send a DMCA notice to <a href="mailto:subscription@digitimes.com">subscription@digitimes.com</a>. This notice must include:</p>
            <ul>
              <li>A description of the infringed content and its location on our website.</li>
              <li>Your contact information.</li>
              <li>A statement that the content has been used without permission.</li>
              <li>A statement assuming the risk of false accusation, signed by the copyright owner or representative.</li>
              <li>Upon receipt of the DMCA notice, we will remove or block access to the content as required. If a user believes that their content has been mistakenly removed or identified as infringing, they can lodge a complaint with us, which we will handle within a reasonable time.</li>
            </ul>
          </div>
          <div class="content-box">
            <a id="user-generated" name="user-generated" class="hideJump"></a>
            <p class="anchor">5. User-Generated Content</p>
            <p>If you upload, post, or share your own content on the DIGITIMES website, you must ensure that you either own the copyright to all the content shared or that you have obtained the necessary authorization and permissions. You should not upload, post, or share any content that infringes on the copyright or other intellectual property rights of others. If we receive a notice of copyright infringement, we may handle it according to our DMCA Notice and Copyright Complaint Mechanism.</p>
          </div>
          <div class="content-box">
            <a id="rules" name="rules" class="hideJump"></a>
            <p class="anchor">6. Rules for Reposting and Sharing</p>
            <p>Content posted by DIGITIMES across various social media platforms may be reposted, shared, and forwarded on the internet for non-commercial purposes, provided that proper attribution is given. Such attribution must include, but is not limited to, the website name, website URL, copyright owner, and other relevant information.</p>
          </div>
          <div class="content-box">
            <a id="links" name="links" class="hideJump"></a>
            <p class="anchor">7. Third-Party Links</p>
            <p>The DIGITIMES website may contain or provide links to websites operated by third parties. Such linked webpages and their associated information are the proprietary property of the respective third-party websites or their legal owners. DIGITIMES disclaims any responsibility for the accuracy, timeliness, or completeness of the content found on these third-party websites.</p>
          </div>
          <div class="content-box">
            <a id="interpretation" name="interpretation" class="hideJump"></a>
            <p class="anchor">8. Applicable Law and Interpretation</p>
            <p>The interpretation and enforcement of this copyright policy, as well as any disputes arising from it, will be governed by the laws of the Republic of China, except for provisions related to foreign civil law where foreign law may apply. Any disputes resulting from this policy will fall under the jurisdiction of the Taiwan Taipei District Court as the court of first instance.</p>
            <p>If you have any questions or concerns about our copyright policy, please contact us at <a href="mailto:subscription@digitimes.com">subscription@digitimes.com</a>.</p>
          </div>
                <p class="CenterText">&nbsp;</p>
                <div id="banner_mid-md" class="mid-ad tablet-show"></div>    		
            </div>
    	</div>
    </div>
