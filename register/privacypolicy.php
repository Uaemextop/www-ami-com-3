...
<head>
    ...
    <meta name="Description" content="DIGITIMES privacy policy"/>
    <meta name="Keywords" content="DIGITIMES, Taiwan, daily news, information, technology, privacy policy, registration, subscription, publication, Asia, Chinese, English"/>
    ...
    <link rel="preload" href="https://img.digitimes.com/ad/en_20260301_dimerco_leaderboard.gif" as="image">
<link rel="preload" href="https://img.digitimes.com/ad/en_20250923_b2b3_button336x90.jpg" as="image">
    ...
    <style>
    #privacy ul {padding:0 0 0 35px;margin:0;}
    #privacy ul li {margin:0;padding:0 0 10px 0;}
    #privacy .img-responsive {margin: 0 auto;}
  ...
  <div class="mobile-nav" id="mobile-nav">
    ...
    <div class="content-frame">
      ...
      <div class="socail-frame">
	    ...
	    <div class="my-container">
	    	<div class="adrow">
                <div id="banner" class="adcol-8"><div class="text-center"><div class="clclgjs" rel="96732"><a href='/webad/cnv.asp?Seq=96732' target='_blank'><img src="https://img.digitimes.com/ad/en_20260301_dimerco_leaderboard.gif" class="awh" style="max-width:728px;" border="0" alt="dimerco" /></a></div></div></div><div id="banner_mid" class="adcol-4"><div class="text-center"><div class="clclgjs" rel="95210"><a href='/webad/cnv.asp?Seq=95210' target='_blank'><img src="https://img.digitimes.com/ad/en_20250923_b2b3_button336x90.jpg" class="awh" style="max-width:336px;" border="0" alt="marketing" /></a></div></div></div>	    	</div>
	    </div>
    </div>
        <div class="gotop">
    ...
    <div class="my-container">	
	    <div class="information-frame" id="privacy">
            <div class="main-title">Privacy Policy</div>
	    	<div class="content">
          <p class="CenterText">Last updated: September 5, 2023</p>
          <p>DIGITIMES Inc. gathers personal information for specific, lawful purposes including but not limited to membership management, customer relations, statistical surveys and analyses, and marketing activities as detailed in the company's official registry. This data enables us to better serve our users by defining essential access parameters for clients, and by tailoring content to individual interests, such as suggesting relevant seminars and news articles. We adhere to robust data protection standards to ensure the confidentiality and integrity of the personal information collected.</p>
          <p>DIGITIMES Inc. is committed to respecting and safeguarding your privacy. To elucidate how we collect, manage, and utilize your personal information, we've formulated the DIGITIMES Privacy Statement (referred to herein as "this Statement"). We strongly recommend that you read this Statement carefully to understand our data handling practices.</p>
          <div class="content-box">
            <p class="toc-up">Table of Contents</p>
            <ul class="custom-list">
              <li><a href="#protection">Compliance with Data Protection Laws</a></li>
              <li><a href="#application">Application scope</a></li>
              <li><a href="#collection">Collection and Handling of Personal Data</a></li>
              <li><a href="#cookie">Cookie usage and server logs</a></li>
              <li><a href="#personalData">Use and Access of Personal Data </a></li>
              <li><a href="#sharing">Sharing information with third parties</a></li>
              <li><a href="#notification">Notification Regarding Third Party Services</a></li>
              <li><a href="#self-protection">Self-protection measures</a></li>
              <li><a href="#exercise">Exercise of personal data rights</a></li>
              <li><a href="#other">Other matters</a></li>
            </ul>
          </div>
          <div class="content-box">
            <a id="protection" name="protection" class="hideJump"></a>
              <p class="anchor">1. Compliance with Data Protection Laws</p>
              <p>The collection, processing, and utilization of users' personal data by DIGITIMES via its website are in accordance with the Personal Data Protection Laws of the Republic of China (Taiwan) and the guidelines set forth in this Statement.</p>
          </div>
          <div class="content-box">
            <a id="application" name="application" class="hideJump"></a>
            <p class="anchor">2. Application scope</p>
              <ul>
                <li><span class="anchor">Inclusion Criteria:</span> This Statement governs the collection, processing, and usage of your personal data when you engage with DIGITIMES. Examples include registration for seminars or courses, online membership enrollment, subscription to e-newsletters, and the purchase of various publications. It also applies to any feedback or inquiries submitted via phone, fax, or the feedback feature on the DIGITIMES website.</li>
                <li><span class="anchor">Exclusion Criteria:</span> When you navigate from the DIGITIMES website to third-party sites, the privacy policy of those third-party websites will take precedence for data protection matters. DIGITIMES disclaims any liability regarding the handling of your personal data on third-party platforms.</li>
              </ul>
          </div>
          <div class="content-box">
            <a id="collection" name="collection" class="hideJump"></a>
            <p class="anchor">3. Collection and Handling of Personal Data</p>
              <ul>
                <li><span class="anchor">Purpose of Collection:</span> When you sign up for a DIGITIMES online membership, you may be asked to provide personal information for identification, service provisioning, and targeted marketing initiatives.</li>
                <li><span class="anchor">Types of Data Collected:</span> The categories of personal data we collect may include your identification details (e.g., name, title, address, phone number, email), social preferences (e.g., hobbies, interests, consumer behavior), educational background, professional qualifications, employment information, and other types of data (e.g., automated system tracking data, website messages).</li>
                <li><span class="anchor">Optional Data:</span> Any questions marked as optional on the DIGITIMES website aim to collect information that enhances your user experience. Omitting these details will not impair your ability to use our services.</li>
                <li><span class="anchor">Data Storage and Security:</span> The personal data you supply will be securely stored within DIGITIMES' databases and will be processed in accordance with our strict standard operating procedures. These processes are overseen by qualified personnel.</li>
                <li><span class="anchor">Consequences of Non-Provision:</span> Failure to provide the required personal data may result in an inability to become a DIGITIMES member or access our full range of services. Incomplete or inaccurate data might also limit your user experience.</li>
                <li>
                  <p class="anchor">Protection of Minors:</p>
                  <ol type="a">
                    <li>We do not intentionally collect personal information from minors under the age of 18, or as mandated by applicable law, without parental or guardian consent.</li>
                    <li>If you are a minor, ensure that you have obtained your guardian's consent before submitting any information. We will proceed only after verifying that guardian consent has been secured. Guardians may revoke consent and request modifications, access, or deletions at any time.</li>
                  </ol>
                </li>
              </ul>
          </div>
          <div class="content-box">
            <a id="cookie" name="cookie" class="hideJump"></a>
            <p class="anchor">4. Cookie usage and server logs</p>
              <ul>
                <li><span class="anchor">Web Traffic and Behavioral Analysis:</span> DIGITIMES uses cookies to enhance our website's functionality and provide a more personalized user experience. When you browse our site, a cookie is saved in your browser, helping us gather non-personal data like your IP address, duration of your visit, and the sections of our site you frequent. We ensure these cookies don't capture any data that can identify you personally, but they help remember your preferences when you revisit our website.</li>
                <li><span class="anchor">Statistical Analysis:</span> The information we collect through cookies is used solely for statistical analysis to improve our website, products, services, and advertising content. This data is not tied to your personal information.</li>
                <li><span class="anchor">Scope of Information:</span> It's important to note that the cookie enables our web server to track only your activities related to the DIGITIMES website; it does not record your browsing history on other websites.</li>
                <li><span class="anchor">Cookie Preferences:</span> If you prefer not to accept cookies, you can disable them through your browser settings. However, doing so may restrict your access to certain features and services offered on our website.</li>
              </ul>
          </div>
          <div class="content-box">
            <a id="personalData" name="personalData" class="hideJump"></a>
            <p class="anchor">5. Use and Access of Personal Data</p>
              <ul>
                <li><span class="anchor">Data Security Measures:</span> DIGITIMES is committed to using your personal data solely for specific, lawful purposes and takes robust administrative, technical, and physical measures to protect it. We strive to prevent unauthorized access, disclosure, alteration, or destruction of your data, as well as loss, theft, or misuse.</li>
                <li><span class="anchor">Purpose of Data Use:</span> DIGITIMES may utilize your personal data for various purposes, including but not limited to:</li>
                <li>
                  <p class="anchor">Data Retention, Location, and Disclosure</p>
                  <ol type="a">
                    <li>Unless otherwise specified, we will retain your personal data for the period necessary to fulfill the purposes for which it was collected, or as required or permitted by law.</li>
                    <li>Your data will be stored on DIGITIMES' primary servers, relevant web/hosting servers, and locations where our services and products are distributed or marketed.</li>
                    <li>Your data may be accessed by DIGITIMES, its affiliates, subsidiaries, and trusted external organizations with whom we conduct business, including service vendors and co-marketing partners.</li>
                    <li>You have the right to request the deletion of your personal data. However, once deleted, you will lose access to the services we provide.</li>
                  </ol>
                </li>
              </ul>
          </div>
          <div class="content-box">
            <a id="sharing" name="sharing" class="hideJump"></a>
            <p class="anchor">6. Sharing information with third parties</p>
            <ul>
              <li>We will not provide, exchange, rent, or sell any of your personal data to other persons or entities, and we strictly prohibit the private use of such personal data by our internal staff unless there is another legal basis or contractual obligation to do so. This provision includes but is not limited to:</li>
              <li>Compliance with applicable laws, regulations, legal processes or government enforcement orders.</li>
              <li>In the event that your actions on the DIGITIMES website violate DIGITIMES' Terms of Service or may harm or prejudice DIGITIMES' rights or cause damage to any person, DIGITIMES may assess the need to disclose your personal information as necessary to identify, contact or take legal action against you.</li>
              <li>To protect DIGITIMES, its users or related organizations from harm to their rights, property, or safety, as required by law or to the extent legally possible.</li>
              <li>If DIGITIMES collects personal data jointly with other companies, we will fulfil our obligation to provide personal data after we have obtained your consent.</li>
            </ul>
          </div>
          <div class="content-box">
            <a id="notification" name="notification" class="hideJump"></a>
            <p class="anchor">7. Notification Regarding Third Party Services</p>
            <p>DIGITIMES incorporates Google Analytics and Google Ads (collectively referred to as "Google Services"), Microsoft Clarity, Meta, X (formerly Twitter) to enhance the quality of our offerings.</p>
          </div>
          <div class="content-box">
            <a id="self-protection" name="self-protection" class="hideJump"></a>
            <p class="anchor">8. Self-protection measures</p>
            <ul>
              <li><span class="anchor">Safeguarding Your Information:</span> It's crucial to keep your password and personal details secure. Do not disclose any sensitive information, especially passwords, to anyone. Make sure to log out of your account after utilizing your membership services. If you're using a shared or public computer, don't forget to close your browser to prevent unauthorized access to your personal data.</li>
              <li><span class="anchor">Forums and Message Boards:</span> If you participate in forums or message boards associated with DIGITIMES, please be aware that any personal information you share will be visible to other users. This information can be read, collected, or used by others and will become public information. While DIGITIMES doesn't control your decision to disclose personal details, we cannot be held responsible for any consequences resulting from such disclosure.</li>
            </ul>
          </div>
          <div class="content-box">
            <a id="exercise" name="exercise" class="hideJump"></a>
            <p class="anchor">9. Exercise of personal data rights</p>
            <ul>
              <li><span class="anchor">Managing Your Information:</span> As a user of DIGITIMES services, you have the ability to update or modify your personal information and password at any time after logging into your account. We strive to maintain accurate, complete, and up-to-date records to better serve you with our products and services.</li>
              <li><span class="anchor">Submitting Requests:</span> Should you find that our website does not adequately address your needs in exercising your personal data rights, you are welcome to send a request for further action to us.</li>
              <li>In addition to updating your information, you also have the right to request the deletion of your personal data and account by sending an email to <a href="mailto:subscription@digitimes.com">subscription@digitimes.com</a>. Upon receiving and verifying your request, DIGITIMES will take appropriate action within 7 business days, unless there are specific exceptions under law or regulation.</li>
            </ul>
          </div>
          <div class="content-box">
            <a id="other" name="other" class="hideJump"></a>
            <p class="anchor">10. Other matters</p>
            <ul>
              <li><span class="anchor">Specialized Privacy Provisions:</span> This statement does not negate the applicability of any more detailed or specific privacy provisions that may exist for particular DIGITIMES services.</li>
              <li><span class="anchor">Periodic Reviews and Updates:</span> DIGITIMES will regularly assess its adherence to this Privacy Policy and will make adjustments as required by legal amendments, technological advancements, or updates to internal management systems. Any changes will be promptly posted on the DIGITIMES website for your review.</li>
              <li><span class="anchor">Acceptance of Updated Terms:</span> The revised Privacy Statement will become effective on the date it is amended. By continuing to use our services, you consent to the terms outlined in this statement.</li>
              <li><span class="anchor">Notification of Policy Changes:</span> In the event of significant changes to this Privacy Statement, we will immediately update it on our website or notify you through the email address associated with your DIGITIMES account. For minor changes, we may not send out notifications, so it is your responsibility to regularly review this Privacy Statement for updates.</li>
            </ul>
          </div>
          <div class="content-box">
            <p>If you have any concerns or suggestions regarding our privacy policy, please contact us at <a href="mailto:subscription@digitimes.com">subscription@digitimes.com</a>.</p>
          </div>
