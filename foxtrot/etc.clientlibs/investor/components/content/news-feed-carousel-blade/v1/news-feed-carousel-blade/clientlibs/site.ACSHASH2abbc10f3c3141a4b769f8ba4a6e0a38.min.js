...
__webpack_require__.d(__webpack_exports__, {
  NewsFeedCarouselBlade: () => (/* binding */ NewsFeedCarouselBlade)
});
...
;// CONCATENATED MODULE: ./src/components/cascade-news-feed-carousel-blade/cascade-news-feed-carousel-blade.styles.ts

const cssPropDefaults = {};
/* harmony default export */ const cascade_news_feed_carousel_blade_styles = (i `
...
.carousel,.carousel-items-container {
    display: flex;
    overflow: hidden;
    background-color: rgb(66, 66, 66); /* Added background color */
    height: 60px; /* Increased height for desktop view */
...
.carousel-navigation-item.active:focus { 
    outline: dotted white 3px
 } 
...
.carousel-item::after {
    ...
    border: solid white;; /* Change border color */
...
;// CONCATENATED MODULE: ./src/components/cascade-news-feed-carousel-blade/index.ts
...
let NewsFeedCarouselBlade = class NewsFeedCarouselBlade extends WithLocalization {
    constructor() {
        super(...arguments);
        /**
         ...
         */
        this.visible = true;
        this.newFeedDetailsUrl = "";
        this.defaultText = "See the latest news from Microsoft ";
        this.defaultLink = "http://news.microsoft.com/";
        this.interValValue = "";
    }
    prepareCarouselItem(href, textContent, carousel, carouselNavigation, index) {
        // Create the <div class="carousel-item">
        const carouselItem = document.createElement("div");
        carouselItem.classList.add("carousel-item");
        carouselItem.setAttribute("id", "feeds-" + (index + 1));
        // Create the <a> element
        const link = document.createElement("a");
        link.setAttribute("target", "_blank"); // Set target="_blank"
        link.setAttribute("aria-label", textContent + " (opens in new window)");
        // Set the href and textContent
        link.setAttribute("href", href);
        link.textContent = textContent;
        // Append the <a> element to the <div class="carousel-item">
    ...
    render() {
      ...
      <div
        class="carousel"
        aria-label="News bar slideshow: navigate using the arrow keys"
      >
        <h2 tabindex="0" class="carousel-title">NEWS</h2>
        <div class="carousel-items-container"></div>
        <div class="carousel-navigator">
          <ul class="carousel-navigation"></ul>
          <moray-icon
            icon="play-icon"
            class="play-icon"
            ariaLabel="Play"
